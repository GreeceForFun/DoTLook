...
if __name__ == "__main__":
    ...
    icon_file_path = Path("~").expanduser() / Path("AppData/Local/GreekProject/DoTLook-main/assets/frame0/disclaimer.ico")
    ...
    image_1 = canvas.create_image(208.0, 287.0, image=image_image_1)
